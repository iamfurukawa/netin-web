...
PWA mobile-first da Fase 2 do GLaDOS.

## Estado atual

- Publicada em `https://glados.13997906387.xyz`.
...
`/status`, `/devices` e `/groups`; `/interactions` redireciona para o início. O Nginx interno usa fallback para `index.html`,
...
`glados.13997906387.xyz`. O build aponta para a API em
`https://glados-server.13997906387.xyz`.
