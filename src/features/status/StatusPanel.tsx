...
export function StatusPanel() {
  ...
  return <section className="status-card" aria-labelledby="status-title">
    ...
    <p className="muted">Escolha como você quer aparecer no seu GLaDOS.</p>
    ...
    {change.isSuccess && <p className="social-success" role="status">{change.data.delivery === "queued" ? "Status sincronizado e enviado aos dispositivos." : "Status salvo. A entrega ao GLaDOS será retomada quando o canal MQTT estiver disponível."}</p>}
